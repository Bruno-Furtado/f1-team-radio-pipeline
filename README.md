...
> Team radio audio and session metadata are sourced from the public [**OpenF1**](https://openf1.org) API — a community-maintained, real-time Formula 1 data project. All credit for the underlying data goes to the [OpenF1 team](https://openf1.org/#about).
...
- Project permissions: `roles/owner` or (Project IAM Admin + Cloud Functions Admin + BigQuery Admin + Storage Admin + Service Usage Admin)
- Python 3.13
